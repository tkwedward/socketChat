...
function createCard(cardData, position){
    ...
    if (position != undefined && position>=0 && position <= allCards.length){
...
submitButton.addEventListener("click", (e)=>{
  ...
  let position = parseInt(document.querySelector(".title").value)
  ...
  let newCard = createCard(cardData, position)
