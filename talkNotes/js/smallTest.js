...
},{"./transports/index":9,"component-emitter":4,"debug":17,"engine.io-parser":23,"parseqs":25,"parseuri":26}],8:[function(require,module,exports){
const parser = require("engine.io-parser");
const Emitter = require("component-emitter");
...
},{"component-emitter":4,"debug":17,"engine.io-parser":23}],9:[function(require,module,exports){
...
},{"../../contrib/xmlhttprequest-ssl/XMLHttpRequest":16,"./polling-jsonp":10,"./polling-xhr":11,"./websocket":14}],10:[function(require,module,exports){
...
},{"../../contrib/xmlhttprequest-ssl/XMLHttpRequest":16,"../globalThis":5,"../util":15,"./polling":12,"component-emitter":4,"debug":17}],12:[function(require,module,exports){
...
},{"../transport":8,"debug":17,"engine.io-parser":23,"parseqs":25,"yeast":43}],13:[function(require,module,exports){
const globalThis = require("../globalThis");
...
},{"./manager":28,"./socket":30,"./url":32,"debug":33,"socket.io-parser":37}],28:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./on":29,"./socket":30,"./typed-events":31,"backo2":2,"debug":33,"engine.io-client":6,"socket.io-parser":37}],29:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.on = void 0;
...
},{"./on":29,"./typed-events":31,"debug":33,"socket.io-parser":37}],31:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"component-emitter":4}],32:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.url = void 0;
const parseuri = require("parseuri");
...
},{"./constructInitialCondition":52}],47:[function(require,module,exports){
"use strict";
...
},{"./GreatNoteSVGDataClass":47,"./constructInitialCondition":52}],50:[function(require,module,exports){
"use strict";
var __createBinding = (this && this.__createBinding) || (Object.create ? (function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    Object.defineProperty(o, k2, { enumerable: true, get: function() { return m[k]; } });
...
},{"./GreatNoteDataClass":46,"./ToolBoxModel":49,"./constructInitialCondition":52,"./pageViewHelperFunction":56}],51:[function(require,module,exports){
...
var MainController = /** @class */ (function () {
    ...
    MainController.prototype.initializeHTMLBackground = function () {
        ...
        var bookmarkArrayId = this.mainDocArray["mainArray_bookmark"];
        ...
        saveButton.addEventListener("click", function (e) {
            var s = exports.mainController.saveMainDoc(true);
    ...
    */
        ...
        if (!arrayHTMLObject) {
            ...
            data.forEach(function (p) {
                ...
                if (mainArrayData_item) {
                    ...
                    console.log(350, initialHTMLObject_1);
    ...
    MainController.prototype.loadMainDoc = function (data) {
        ...
        console.log(353, exports.mainController.mainDoc);
        this.previousDoc = this.mainDoc;
        ...
        rootArray.forEach(function (mainArray) {
            ...
            mainArray["array"].forEach(function (elem) {
                ...
                _this.renderDataToHTML(elem["array"]);
...
},{"./socketFunction":57,"automerge":1}],53:[function(require,module,exports){
...
},{"./GreatNoteDataClass":46,"./GreatNoteSvgDataClass":48,"./constructInitialCondition":52}],56:[function(require,module,exports){
"use strict";
exports.__esModule = true;
...
function createNewPage(currentStatus, fullPageModeDiv, overviewModeDiv, pageToAttach, htmlObject) {
    var newPage;
    var smallView;
    if (currentStatus.htmlObject) {
        // may be better to use a function here
        // here the htmlObject is the GNContainerDiv objeect
        // mainController.mainDocArray["mainArray_pageFull"] is the id of the arrayId of the pageFull and pageOverview object
        newPage = currentStatus.htmlObject("", constructInitialCondition_1.mainController.mainDocArray["mainArray_pageFull"], false, false, true);
        smallView = currentStatus.htmlObject("", constructInitialCondition_1.mainController.mainDocArray["mainArray_pageOverview"], false, newPage._identity.dataPointer, true);
    }
    else {
...
},{"./constructInitialCondition":52}],57:[function(require,module,exports){
"use strict";
var __createBinding = (this && this.__createBinding) || (Object.create ? (function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    Object.defineProperty(o, k2, { enumerable: true, get: function() { return m[k]; } });
...
},{"./constructInitialCondition":52,"socket.io-client":27}],58:[function(require,module,exports){
'use strict'
