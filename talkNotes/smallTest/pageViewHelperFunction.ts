...
export function pageController(currentStatus, subPanelContainer){
    ...
    let leftPageArrayDiv = document.createElement("div")
    let rightPageArrayDiv = document.createElement("div")
    ...
    leftButton.addEventListener("click", function(){
        let totalPageNumber = currentStatus.pageArray.length
...
export function createNewPage(currentStatus, fullPageModeDiv, overviewModeDiv, pageToAttach, htmlObject?:HTMLElement|HTMLDivElement){
    let newPage
    let smallView
    if (currentStatus.htmlObject){
        ...
        newPage = currentStatus.htmlObject("", mainController.mainDocArray["mainArray_pageFull"], false, false, true)
        smallView = currentStatus.htmlObject("", mainController.mainDocArray["mainArray_pageOverview"], false, newPage._identity.dataPointer, true)
    } else {
...
//@auto-fold here
export function createNewPageEvent(currentStatus, fullPageModeDiv, overviewModeDiv, pageToAttach, pageDummyContent, htmlObject?:HTMLElement|HTMLDivElement){
    // when click the new page button, a new page is created.

    // add new page fullPageMode
    let clickEventAction = function (){
          let [newPage, smallView] = createNewPage(currentStatus, fullPageModeDiv, overviewModeDiv, pageToAttach, htmlObject)
...
function highlightCurrentPageInOverviewMode(smallPageView:HTMLDivElement, currentPageNumber: number, currentStatus){
